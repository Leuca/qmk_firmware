...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, L_T_MD,  L_T_ONF, _______, L_EDG_M, MD_BOOT, NK_TOGG, _______, _______, _______, _______, _______,          KC_BRIU, KC_VOLD,
        _______, _______, _______,                            DBG_FAC,                            _______, _______, _______, KC_BRID, _______
    ),
    /*
    [X] = LAYOUT(
...
led_instruction_t led_instructions[] = {
    ...
    //Flags can be found in users/drop_led_Leuca/lib/led_framework/md_rgb_matrix.h (prefixed with LED_FLAG_)
	...
	// Keys are white, modifiers are coral
	// All modifiers are coral      (id0  32 -   1: 0110 0000 0000 0000 1110 0000 0000 0001  = 0x6000E001)
	// All modifiers are coral      (id1  64 -  33: 1101 1111 1000 0000 0001 1100 0000 0000  = 0xDF801C00)
	// All modifiers are coral      (id2  67 -  65: 0000 0000 0000 0000 0000 0000 0000 0111  = 0x00000007)
	{ .flags = LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB, .id0 = 0x6000E001, .id1 = 0xDF801C00, .id2 = 0x00000007, .r = 255, .g = 124, .b = 77},
	// All keys are white      (id0  32 -   1: 1001 1111 1111 1111 0001 1111 1111 1110  = 0x9FFF1FFE)
	// All keys are white      (id1  64 -  33: 0010 0000 0111 1111 1110 0011 1111 1111  = 0x207FE3FF)
	// All keys are white      (id2  67 -  65: 0000 0000 0000 0000 0000 0000 0000 0000  = 0x00000000)
	{ .flags = LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB, .id0 = 0x9FFF1FFE, .id1 = 0x207FE3FF, .id2 = 0x00000000, .r = 255, .g = 255, .b = 255},
	// Underglow               (id3  95 -  68: 1111 1111 1111 1111 1111 1111 1111 1000 = 0xFFFFFFF8)
	// Underglow               (id4 105 -  96: 0000 0000 0000 0000 0000 0011 1111 1111 = 0x000003FF)
	{ .flags = LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB, .id2 = 0xFFFFFFF8, .id3 = 0x000003FF, .r = 71, .g = 0, .b = 140},
